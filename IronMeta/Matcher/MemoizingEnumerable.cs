...
{
    public class MemoizingEnumerable<T> : IList<T>
    {
        IList<T> memoList = new List<T>();
        readonly IEnumerator<T> innerEnumerator;

        public MemoizingEnumerable(IEnumerable<T> inner)
        {
        ...
        {
            int index;
            MemoizingEnumerable<TE> inner;

            public MemoizingEnumerator(MemoizingEnumerable<TE> inner)
            {
                this.inner = inner;
                Reset();
            }
